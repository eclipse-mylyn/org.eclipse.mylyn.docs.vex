...
/**
 * Manager of a set of configuration items and their associated resources. One
 * concrete implementation of this interface will exist for each kind of
 * configuration item, e.g. a DoctypeManager, StyleManager, etc. Further, each
 * Vex plugin and Vex plugin project will have one of each kind of manager. All
 * managers are registered with the VexPlugin class.
 */
public interface IConfigItemFactory {
	 ...
	 * null instead of an empty array. This is essentially the inverse of the
	 * createItem method.
	 * 
	 * @param item
	...
	/**
	 * Returns the ID of the extension point that defines this type of
	 * configuration item.
	 */
	...
	/**
	 * Returns the pluralized name of the type of configuration item managed by
	 * this factory. For example, "Document Types".
	 * 
	 * @return
	 */
